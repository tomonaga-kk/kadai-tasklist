        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 sm:max-w-md">
              <input type="text" name="content" id="content" autocomplete="content" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900" placeholder="Lesson17を完了する" value="{{$task->content}}">
            </div>
          </div>
        </div>
